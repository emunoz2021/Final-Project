...
public class PanelExtraAnimales extends JPanel {
    ...
    public PanelExtraAnimales(PanelsubPrincipal panelSubPrincipal) {
    ...
    private void oyenteBotonGorilla(){
        MouseListener listenerGorilla = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                ventanita.getLayeredPane().remove(PanelExtraAnimales.this);
